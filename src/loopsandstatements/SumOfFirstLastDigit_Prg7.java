...
public class SumOfFirstLastDigit_Prg7 {

    //method named sumFirstAndLastDigit with int return type with one parameter
    ...
    public static void main(String[] args) {        //Main method
        ...
        //Print Statement and call method via class name
        System.out.println(SumOfFirstLastDigit_Prg7.sumFirstAndLastDigit(252));
        System.out.println(SumOfFirstLastDigit_Prg7.sumFirstAndLastDigit(257));
        System.out.println(SumOfFirstLastDigit_Prg7.sumFirstAndLastDigit(0));
        System.out.println(SumOfFirstLastDigit_Prg7.sumFirstAndLastDigit(5));
        System.out.println(SumOfFirstLastDigit_Prg7.sumFirstAndLastDigit(-10));
