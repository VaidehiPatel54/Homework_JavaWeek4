...
public class Rectangle {
    ...
    public Rectangle(double width,double length) {      //constructor with parameters width and length
    ...
    //instance methods
    public double getWidth(){                   //method with return type without any parameters,
        return this.width;
    }
    public double getLength(){                  //method with return type without any parameters,
        return this.length;
    }
