...
public class PalindromNumber_Prg5 {

    //method name isPalindrome with return type int with one parameter
    ...
    public static void main(String[] args) {
        ...
        System.out.println(PalindromNumber_Prg5.isPalindrome(-1221));
        System.out.println(PalindromNumber_Prg5.isPalindrome(707));
        System.out.println(PalindromNumber_Prg5.isPalindrome(11212));
